...
//   ((...args: Array<any>) => Generator<A | Promise<A>, any, any>)
//   | ((...args: Array<any>) => AsyncGenerator<A, any, any>)
export type Sink<A> = {
...
export function empty<A>(): Stream<A>// should be <void>, but this breaks some things
export function never<A>(): Stream<A>
export function from<A, T/*:::Array<A>| Iterable<A> | Iterator<A> | Observable<A>*/>(as: T): Stream<A>
export function periodic<A>(period: number, a?: A): Stream<A>
export function fromEvent<T, Target>(event: string, target: Target, useCapture?: boolean): Stream<T>
...
export function observe<A, B>(f: (a: A) => B, s: Stream<A>): Promise<B>
export function forEach<A, B>(f: (a: A) => B, s: Stream<A>): Promise<B>
export function drain<A>(s: Stream<A>): Promise<void>  //not sure
...
export function continueWith<A, B>(f: () => Stream<B>, s: Stream<A>): Stream<A | B>
...
export function combineArray<A, B, R>(fn: (a: A, b: B) => R, streams: [Stream<A>, Stream<B>]): Stream<R>
export function combineArray<A, R>(fn: (...items: Array<A>) => R, streams: Array<Stream<A>>): Stream<R>
...
export function until<A, B>(signal: Stream<B>, s: Stream<A>): Stream<A>
export function takeUntil<A, B>(signal: Stream<B>, s: Stream<A>): Stream<A>
export function since<A, B>(signal: Stream<B>, s: Stream<A>): Stream<A>
export function skipUntil<A, B>(signal: Stream<B>, s: Stream<A>): Stream<A>
export function during<A, B>(timeWindow: Stream<Stream<B>> , s: Stream<A>): Stream<A>
...
export function sample<A, B, S, R>(
  fn: (a: A, b: B) => R,
  sampler: Stream<S>,
  a: Stream<A>,
  b: Stream<B>
): Stream<R>
export function sampleWith<A, S>(sampler: Stream<S>, s: Stream<A>): Stream<A>
...
export function throwError<E/*::: Error*/>(e: E): Stream<E>
