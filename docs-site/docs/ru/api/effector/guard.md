...
::: info
C effector 22.2.0 предпочтительнее использовать [sample](docs/ru/api/effector/sample.md)
:::
...
- Если `target` не передан, будет создано новое [событие](docs/ru/api/effector/Event.md) и возвращено в качестве результата
- Если `filter` это [стор](docs/ru/api/effector/Store.md), то его значение будет проверено на [истинность](https://developer.mozilla.org/ru/docs/Glossary/Truthy)
...
- **`filter`**: [Стор](docs/ru/api/effector/Store.md) или функция-предикат

  **Разновидности**:

  - **стор**: `target` будет запущен только если в этом сторе [истинное значение](https://developer.mozilla.org/ru/docs/Glossary/Truthy)
  - **функция-предикат** `(source, clock) => boolean`: `target` будет запущен только если эта функция вернёт [истинное значение](https://developer.mozilla.org/ru/docs/Glossary/Truthy). Функция [должна быть **чистой**](docs/ru/glossary.mdmd#purity)
...
- **`clock?`**: [Юнит](docs/ru/glossary.mdmd#common-unit) или массив юнитов
  ...
  **Разновидности**:
  ...
  - **массив юнитов**: срабатывание любого из юнитов, после проверки условия в `filter` будет запускать `target`. Сокращение для вызова [merge](docs/ru/api/effector/merge.md)
...
- **`target?`**: [Юнит](docs/ru/glossary.mdmd#common-unit) или массив юнитов
  ...
  **Разновидности**:
  ...
  - **поле отсутствует**: новое [событие](docs/ru/api/effector/Event.md) будет создано и возвращено в результате вызова guard

**Возвращает**

[_Event_](docs/ru/api/effector/Event.md), событие, которое будет срабатывать после после проверки условия в `filter`
...
- **`filter`**: [Стор](docs/ru/api/effector/Store.md) или функция-предикат
  ...
  **Разновидности**:
  ...
  - **стор**: `target` будет запущен только если в этом сторе [истинное значение](https://developer.mozilla.org/ru/docs/Glossary/Truthy)
  - **функция-предикат** `(source) => boolean`: `target` будет запущен только если эта функция вернёт [истинное значение](https://developer.mozilla.org/ru/docs/Glossary/Truthy). Функция [должна быть **чистой**](docs/ru/glossary.mdmd#purity)
