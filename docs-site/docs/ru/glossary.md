...
[Event](docs/ru/apiru/api/effector/Event.md) в документации
...
[Store](docs/ru/apiru/api/effector/Store.md) в документации
...
[Effect](docs/ru/apiru/api/effector/Effect.md) в документации
...
[Domain](docs/ru/apiru/api/effector/Domain.md) в документации
...
Обычные юниты можно использовать для запуска обновлений других юнитов. Существует три типа обычных юнитов: [store (стор)](docs/ru/apiru/api/effector/Store.md), [event (событие)](docs/ru/apiru/api/effector/Event.md) и [effect (эффект)](docs/ru/apiru/api/effector/Effect.md). **Когда метод принимает юниты, это означает, что он принимает события, эффекты и сторы** в качестве источника реактивных обновлений
...
[store.map в документации](docs/ru/apiru/api/effector/Store.md#map)

[store.watch в документации](docs/ru/apiru/api/effector/Store.md#watch)
...
[forward in docs](docs/ru/apiru/api/effector/forward.md)
...
_Watcher_ - функция с сайд-эффектами, для работы которых не нужны возможности по перехвату ошибок и уведомления подписчиков об завершении асинхронной работы. Используется в [event.watch](docs/ru/apiru/api/effector/Event.md#watchwatcher), [store.watch](docs/ru/apiru/api/effector/Store.md#watchwatcher) и [хуках домена](docs/ru/apiru/api/effector/Domain.md#oncreateeventhook). Возвращаемое значение игнорируется
...
[effect]: docs/ru/apiru/api/effector/Effect.md
[store]: docs/ru/apiru/api/effector/Store.md
[event]: docs/ru/apiru/api/effector/Event.md
[domain]: docs/ru/apiru/api/effector/Domain.md
[scope]: docs/ru/apiru/api/effector/Scope.md
