...
describe('combinable', () => {
  describe('source:wide', () => {
    test('source:wide (should pass)', () => {
      ...
      expect(typecheck).toMatchInlineSnapshot(`
        "
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; target: Event<[number, string]>[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; clock: Event<number>; target: Event<[number, string]>[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; target: Event<[number]>[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; target: (Event<[number]> | Event<[number, string]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; clock: Event<number>; target: Event<[number]>[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; clock: Event<number>; target: (Event<[number]> | Event<[number, string]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        "
      `)
    })
    test('source:wide (should fail)', () => {
      ...
      expect(typecheck).toMatchInlineSnapshot(`
        ...
        Argument of type '{ filter: () => boolean; source: { a: Store<number>; b: Store<string>; }; clock: Event<number>; target: Event<AS>[]; }' is not assignable to parameter of type '{ error: \\"source should extend target type\\"; targets: { sourceType: { a: number; b: string; }; targetType: AS; }[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source should extend target type\\"; targets: { sourceType: { a: number; b: string; }; targetType: AS; }[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; target: Event<[string]>[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; target: (Event<[number]> | Event<[string]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; target: (Event<[number, string]> | Event<[number, number]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; target: (Event<[number]> | Event<[number, number]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; target: (Event<[string]> | Event<[number, string]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; target: (Event<[string]> | Event<[number, number]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; target: Event<[number, number]>[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; target: (Event<[string]> | Event<[number, number]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; clock: Event<number>; target: Event<[string]>[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; clock: Event<number>; target: (Event<[number]> | Event<[string]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; clock: Event<number>; target: (Event<[number]> | Event<[number, number]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; clock: Event<number>; target: (Event<[string]> | Event<[number, string]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; clock: Event<number>; target: (Event<[string]> | Event<[number, number]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; clock: Event<number>; target: (Event<[string]> | Event<[number, number]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; clock: Event<number>; target: (Event<[number, string]> | Event<[number, number]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        Argument of type '{ filter: () => boolean; source: (Store<number> | Store<string>)[]; clock: Event<number>; target: Event<[number, number]>[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: (Store<number> | Store<string>)[]; }'.
        "
      `)
    })
  ...
  describe('source:same', () => {
    test('source:same (should pass)', () => {
      ...
      expect(typecheck).toMatchInlineSnapshot(`
        "
        Argument of type '{ filter: () => boolean; source: Store<number>[]; target: Event<[number]>[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; clock: Event<number>; target: Event<[number]>[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        "
      `)
    })
    test('source:same (should fail)', () => {
      ...
      expect(typecheck).toMatchInlineSnapshot(`
        ...
        Argument of type '{ filter: () => boolean; source: { a: Store<number>; }; clock: Event<number>; target: (Event<AS> | Event<AB>)[]; }' is not assignable to parameter of type '{ error: \\"source should extend target type\\"; targets: { sourceType: { a: number; }; targetType: AS | AB; }[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source should extend target type\\"; targets: { sourceType: { a: number; }; targetType: AS | AB; }[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; target: Event<[string]>[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; target: Event<[number, string]>[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; target: Event<[number, number]>[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; target: (Event<[number]> | Event<[string]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; target: (Event<[number]> | Event<[number, string]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; target: (Event<[number]> | Event<[number, number]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; target: (Event<[string]> | Event<[number, number]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; target: (Event<[string]> | Event<[number, string]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; target: (Event<[number, string]> | Event<[number, number]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; target: (Event<[string]> | Event<[number, number]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; clock: Event<number>; target: Event<[string]>[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; clock: Event<number>; target: Event<[number, string]>[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; clock: Event<number>; target: Event<[number, number]>[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; clock: Event<number>; target: (Event<[number]> | Event<[string]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; clock: Event<number>; target: (Event<[number]> | Event<[number, string]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; clock: Event<number>; target: (Event<[number]> | Event<[number, number]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; clock: Event<number>; target: (Event<[string]> | Event<[number, number]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; clock: Event<number>; target: (Event<[string]> | Event<[number, string]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; clock: Event<number>; target: (Event<[number, string]> | Event<[number, number]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        Argument of type '{ filter: () => boolean; source: Store<number>[]; clock: Event<number>; target: (Event<[string]> | Event<[number, number]>)[]; }' is not assignable to parameter of type '{ error: \\"source error\\"; got: Store<number>[]; }'.
          Object literal may only specify known properties, and 'filter' does not exist in type '{ error: \\"source error\\"; got: Store<number>[]; }'.
        "
