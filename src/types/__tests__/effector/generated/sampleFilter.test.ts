  ...
  describe('[clock], fn -> unit same', () => {
    ...
    test('[clock], fn -> unit same (should fail)', () => {
      ...
      expect(typecheck).toMatchInlineSnapshot(`
        ...
        Object is possibly 'null'.
        Property 'c' does not exist on type 'ABN'.
        Argument of type '[{ clock: [Event<AB>, Event<AB | null>]; target: Store<AB>; filter: (clk: AB) => boolean; fn: (val: ABN) => { a: any; b: string; }; }]' is not assignable to parameter of type '[config: { clock: [Event<AB>, Event<AB | null>]; source?: undefined; filter?: (((clk: AB | null) => clk is AB | null) & ((clk: AB | null) => clk is AB | null)) | undefined; fn?: (((clk: AB | null) => any) & ((clk: AB | null) => any)) | undefined; target: Store<...>; greedy?: boolean | undefined; } & { ...; }] | [con...'.
                  ...
                  Type '(clk: AB) => boolean' is not assignable to type '(clk: AB | null) => boolean'.
                    Types of parameters 'clk' and 'clk' are incompatible.
                      Type 'AB | null' is not assignable to type 'AB'.
                        Type 'null' is not assignable to type 'AB'.
        Property 'c' does not exist on type 'ABN'.
        Argument of type '[{ clock: [Event<AB>, Event<AB | null>]; target: Store<AB>; filter: () => number; fn: (val: ABN) => { a: any; b: string; }; }]' is not assignable to parameter of type '[config: { clock: [Event<AB>, Event<AB | null>]; source?: undefined; filter?: (((clk: AB | null) => clk is AB | null) & ((clk: AB | null) => clk is AB | null)) | undefined; fn?: (((clk: AB | null) => any) & ((clk: AB | null) => any)) | undefined; target: Store<...>; greedy?: boolean | undefined; } & { ...; }] | [con...'.
