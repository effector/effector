  ...
  describe('assert fn args', () => {
    test('assert fn args (should pass)', () => {
      ...
      expect(typecheck).toMatchInlineSnapshot(`
        ...
        lack of expected error at test line 18 'target: exact,'
        lack of expected error at test line 25 'target: exact,'
        lack of expected error at test line 32 'target: exact,'
        "
      `)
    })
