...
describe('generic edge cases', () => {
  ...
  test('generic edge cases (should fail)', () => {
    ...
    expect(typecheck).toMatchInlineSnapshot(`
      ...
      Argument of type '[{ clock: Event<B>; source: Store<A>; filter: BooleanConstructor; target: Event<B>; }]' is not assignable to parameter of type '[[NonNullable<A>] extends [Readonly<B>] ? Event<B> : WhichType<B> extends \\"any\\" | \\"void\\" ? Event<B> : { sourceType: NonNullable<A>; targetType: B; }] extends [...] ? [config: ...] : [...] extends [...] ? [config: ...] : [message: ...]'.
