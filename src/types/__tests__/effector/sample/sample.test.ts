...
describe('generic edge cases', () => {
  ...
  test('generic edge cases (should fail)', () => {
    ...
    expect(typecheck).toMatchInlineSnapshot(`
      "
      Argument of type '[{ source: Store<A>; clock: Event<B>; target: Event<B>; }]' is not assignable to parameter of type '[[A] extends [Readonly<B>] ? Event<B> : WhichType<B> extends \\"any\\" | \\"void\\" ? Event<B> : { sourceType: A; targetType: B; }] extends [...] ? [config: ...] : [...] extends [...] ? [config: ...] : [message: ...]'.
      Argument of type '[{ source: Store<A>; clock: Event<B>; fn: (source: A, clock: B) => A; target: Event<B>; }]' is not assignable to parameter of type '[[A] extends [Readonly<B>] ? Event<B> : WhichType<B> extends \\"any\\" | \\"void\\" ? Event<B> : { fnResult: A; targetType: B; }] extends [...] ? [config: ...] : [...] extends [...] ? [config: ...] : [message: ...]'.
      Argument of type '[{ source: Store<A>; clock: Event<B>; fn: (source: A, clock: B) => B; target: Store<A>; }]' is not assignable to parameter of type '[[B] extends [Readonly<A>] ? Store<A> : WhichType<A> extends \\"any\\" | \\"void\\" ? Store<A> : { fnResult: B; targetType: A; }] extends [...] ? [config: ...] : [...] extends [...] ? [config: ...] : [message: ...]'.
      Argument of type '[{ clock: Event<B>; source: Store<A>; filter: BooleanConstructor; target: Event<B>; }]' is not assignable to parameter of type '[[NonFalsy<A>] extends [Readonly<B>] ? Event<B> : WhichType<B> extends \\"any\\" | \\"void\\" ? Event<B> : { sourceType: NonFalsy<A>; targetType: B; }] extends [...] ? [config: ...] : [...] extends [...] ? [config: ...] : [message: ...]'.
      Argument of type '[{ clock: Event<B>; source: Store<A>; filter: BooleanConstructor; fn: (source: NonFalsy<A>, clock: B) => B; target: Store<A>; }]' is not assignable to parameter of type '[[B] extends [Readonly<A>] ? Store<A> : WhichType<A> extends \\"any\\" | \\"void\\" ? Store<A> : { fnResult: B; targetType: A; }] extends [...] ? [config: ...] : [...] extends [...] ? [config: ...] : [message: ...]'.
      Argument of type '[{ clock: Event<B>; source: Store<A>; filter: (source: A, clock: B) => true; fn: (source: A, clock: B) => B; target: Store<A>; }]' is not assignable to parameter of type '[[B] extends [Readonly<A>] ? Store<A> : WhichType<A> extends \\"any\\" | \\"void\\" ? Store<A> : { fnResult: B; targetType: A; }] extends [...] ? [config: ...] : [...] extends [...] ? [config: ...] : [message: ...]'.
      "
    `)
  })
})
