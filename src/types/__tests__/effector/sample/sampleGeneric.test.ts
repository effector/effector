...
describe('generic with either type', () => {
  ...
  test('generic matching (should fail)', () => {
    ...
    expect(typecheck).toMatchInlineSnapshot(`
      ...
      Argument of type '[{ clock: Event<Either<L, R>>; fn: (data: Either<L, R>) => R | null; target: EventCallable<L | null>; }]' is not assignable to parameter of type '[[R | null] extends [Readonly<L | null>] ? EventCallable<L | null> : WhichType<L | null> extends \\"any\\" | \\"void\\" ? EventCallable<...> : { ...; }] extends [...] ? [config: ...] : [...] extends [...] ? [config: ...] : ([...] extends [...] ? \\"yes\\" : \\"no\\") extends \\"yes\\" ? [error: ...] : [error: ...]'.
