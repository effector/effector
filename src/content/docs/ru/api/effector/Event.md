...
### Формула {#event-watch-watcher-formulae}
...
### Аргументы {#event-watch-watcher-arguments}
...
### Возвращает {#event-watch-watcher-returns}
...
### Пример {#event-watch-watcher-example}
...
### Аргументы {#event-map-fn-arguments}
...
### Возвращает {#event-map-fn-returns}

Новое, производное событие

### Пример {#event-map-fn-example}
...
### Формула {#event-prepend-fn-formulae}
...
### Аргументы {#event-prepend-fn-arguments}
...
### Возвращает {#event-prepend-fn-returns}

Новое событие

### Пример {#event-prepend-fn-example}

##### Пример использования {#event-prepend-fn-examples-usage}
...
### Формула {#event-filterMa-formulae}
...
### Аргументы {#event-filterMap-fn-arguments}
...
### Возвращает {#event-filterMap-fn-returns}

Новое, производное событие

### Пример {#event-filterMap-fn-example}

#### Использование с методами JavaScript возвращающими undefined {#event-filterMap-fn-example-usage-with-functions-returning-undefined}
...
#### Использование c nullable React ref  {#event-filterMap-fn-example-usage-with-nullable-ref}
...
### Формула {#event-filter-fn-formulae}
...
### Аргументы {#event-filter-fn-arguments}
...
### Возвращает {#event-filter-fn-returns}
...
### Пример {#event-filter-fn-example}
...
### Формула {#event-shortName-formulae}
