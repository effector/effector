...
describe('skipVoid error messages', () => {
  ...
  test('Simple store', () => {
    ...
    expect(getErrorStacks()).toMatchInlineSnapshot(`
      ...
      ,__tests__/error-stacks/skip-void-messages.test.ts:4:1)
      ",
      ]
    `)
  })
  ...
  test('Sidless store', () => {
    ...
    expect(getErrorStacks()).toMatchInlineSnapshot(`
      ...
      ,__tests__/error-stacks/skip-void-messages.test.ts:5:1)
      ",
      ]
    `)
  })
  ...
  test('Simple derived', () => {
    ...
    expect(getErrorStacks()).toMatchInlineSnapshot(`
      ...
      ,__tests__/error-stacks/skip-void-messages.test.ts:6:1)
      ",
  ...
  test('Sidless derived', () => {
    ...
    expect(getErrorStacks()).toMatchInlineSnapshot(`
      ...
      ,__tests__/error-stacks/skip-void-messages.test.ts:7:1)
      ",
