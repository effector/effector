...
const comparator = (a: GraphEdge<string>, b: GraphEdge<string>) => {
  if (a === b) return (0: 0)
  const as = a.toString()
  const bs = b.toString()
  if (as === bs) return (0: 0)
...
describe('depthFirstSearch', () => {
  it('should perform DFS operation on graph', () => {
    ...
    const vertexA = new GraphVertex('A', comparator)
    const vertexB = new GraphVertex('B', comparator)
    const vertexC = new GraphVertex('C', comparator)
    const vertexD = new GraphVertex('D', comparator)
    const vertexE = new GraphVertex('E', comparator)
    const vertexF = new GraphVertex('F', comparator)
    const vertexG = new GraphVertex('G', comparator)
