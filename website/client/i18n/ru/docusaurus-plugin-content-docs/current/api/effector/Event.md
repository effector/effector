...
1.  **`fn`**: `(data: T) => S`
    ...
    **Возвращает**
    ...
    Новое значение для передачи в производное событие `eventB`
...
1.  **`fn`**: `(data: T) => S`
    ...
    **Возвращает**
    ...
    Новое значение для передачи в исходное событие `targetEvent`
...
1.  **`fn`**: `(data: T) => S | void`
    ...
    **Возвращает**
    ...
    Новое значение для передачи в производное событие `eventB` либо _undefined_, если вызов `eventB` не требуется
