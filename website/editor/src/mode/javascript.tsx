...
;(function(mod) {
  ...
  CodeMirror.defineMode('javascript', function(config, parserConfig) {
    ...
    const isFlow = parserConfig.flow
    ...
    function classBody(type, value) {
      ...
      if (type == '[')
        return cont(
          ...
          maybetype,
          expect(']'),
          isTS || isFlow ? classfield : functiondef,
          classBody,
        )
      if (value == '*') {
        cx.marked = 'keyword'
  ...
  CodeMirror.defineMIME('text/flow', {
    name: 'javascript',
    flow: true,
  })
  CodeMirror.defineMIME('application/flow', {
    name: 'javascript',
    flow: true,
  })
})
