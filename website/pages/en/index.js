...
class HomeSplash extends React.Component {
  render() {
    ...
    const ProjectTitle = () => (
      ...
      <img alt={siteConfig.title} src={`${siteConfig.baseUrl}img/comet.png`} />
    ...
    const Button = props => (
      <div className="pluginWrapper buttonWrapper">
        <a className={`button ${props.className}`} href={props.href} target={props.target}>
          {props.children}
        </a>
      </div>
    );
  ...
  render() {
    ...
    const Features = () => (
      <Block layout="threeColumn">
        {[
          {
            content: 'TypeScript and Flow support out of box, simple API surface and helpful community.',
            title: 'Developer-friendly',
          },
          {
            content: 'Static initialization provides boost in performance for runtime.',
