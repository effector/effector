...
We recommend using the [@withease/factories](https://withease.effector.dev/factories/) library for factories.
This is necessary for proper effector work with SSR because your stores need to have a unique sid.
You can read more about it [here](/en/explanation/sids/#unique-sids).
