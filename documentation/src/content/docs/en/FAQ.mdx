...
Effector plugins insert special tags - SIDs - into the code, which helps to automate serialization and deserialization of stores, so users don't have to think about it. See [article about sids](/en/explanation/sids) for more info.
