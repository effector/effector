...
An official SWC plugin for SSR and improved debugging in SWC-powered projects like [Next.js](https://nextjs.org) or Vite with the [vite-react-swc plugin](https://github.com/vitejs/vite-plugin-react-swc).
