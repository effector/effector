---
title: effector
description: List of main API methods, grouped
redirectFrom:
  - /api/effector
---

# Effector API (#effector-api)

Effector API reference:

## Unit Definitions (#unit-definitions)

- [`Event<T>`](/en/api/effector/Event)
- [`Effect<Params, Done, Fail>`](/en/api/effector/Effect)
- [`Store<T>`](/en/api/effector/Store)
...
- [`createStore(default)`](/en/api/effector/createStore)
- [`createEffect(handler)`](/en/api/effector/createEffect)
...
- [`serialize(scope)`](/en/api/effector/serialize)
- [`allSettled(unit, { scope })`](/en/api/effector/allSettled)
- [`scopeBind(event)`](/en/api/effector/scopeBind)
- [`hydrate(domain)`](/en/api/effector/hydrate)
