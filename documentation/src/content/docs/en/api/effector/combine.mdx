...
Result will be saved in created store. This function [must be **pure**](/en/explanation/glossary#purity). `combine` function called synchronously during combine call, if this function will throw an error, application will crash. This will be fixed in [24 release](https://github.com/effector/effector/issues/1163)
