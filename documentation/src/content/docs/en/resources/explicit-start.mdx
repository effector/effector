...
Fork API allows you to create [scope](/en/api/effector/Scope) which will be used across the app. It helps you to prevent using global state and avoid unexpected behavior.
...
3. Trigger `appStarted` [event](/en/api/effector/Event) on the particular [scope](/en/api/effector/Scope).
