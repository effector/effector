...
Additionally, we also have a [ChatGPT effector assistant](https://chatgpt.com/g/g-thabaCJlt-effector-assistant), and [repository uploaded to DeepWiki](https://deepwiki.com/effector/effector), where AI will help you understand how to work with effector.
