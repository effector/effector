...
Он предоставляет всем [Юнитам](/en/explanation/glossary#unit) уникальные `SID` ([Стабильные Идентификаторы](/en/explanation/sids)) и имена, а также другую отладочную информацию.
