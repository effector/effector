...
Помимо прочего у нас также существует [ChatGPT effector assistant](https://chatgpt.com/g/g-thabaCJlt-effector-assistant), а также [репозиторий загруженный в DeepWiki](https://deepwiki.com/effector/effector), где AI поможет вам разобраться как работать с effector.
