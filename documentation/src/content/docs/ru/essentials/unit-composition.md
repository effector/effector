...
# Объединение юнитов в effector (#unit-composition)
...
`sample` позволяет фильтровать данные с помощью параметра `filter`:
...
#### Нескольких источников данных (#sample-multiple-sources)
