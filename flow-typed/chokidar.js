import {FSWatcher as Watch} from 'fs'

declare module 'chokidar' {
  // import type {FSWatcher as Watch} from 'fs'
  declare export type WatchedPaths = {
    [directory: string]: string[],
    ...,
  }

  declare export type AwaitWriteFinishOptions = {
    /**
  ...
  declare export class FSWatcher extends Watch {
    /**
     * Constructs a new FSWatcher instance with optional WatchOptions parameter.
     */
    constructor(options?: WatchOptions): FSWatcher;
