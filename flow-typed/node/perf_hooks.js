...
declare module 'perf_hooks' {
  declare export interface PerformanceEntry {
    /**
  ...
  declare export interface PerformanceNodeTiming extends PerformanceEntry {
    /**
  ...
  declare export interface Performance {
    /**
  ...
  declare export interface PerformanceObserverEntryList {
    /**
  ...
  declare export class PerformanceObserver extends AsyncResource {
    constructor(callback: PerformanceObserverCallback): PerformanceObserver;
