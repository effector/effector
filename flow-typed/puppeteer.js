declare module 'puppeteer' {
  ...
  declare class Page extends OverridableEventEmitter {
    /**
     * The method runs document.querySelector within the page.
     * If no element matches the selector, the return value resolve to null.
     */
    ...
    exposeFunction<I, O>(
      name: string,
      puppeteerFunction: (...args: Array<empty>) => mixed,
    ): Promise<void>;
     ...
     */
    setViewport(viewport: $Shape<Viewport>): Promise<void>;
  ...
  declare class Browser extends OverridableEventEmitter {
    /**
