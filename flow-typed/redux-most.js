declare module 'redux-most' {
  ...
  *****************************************/
  ...
  declare export type Epic<A, S> =
    (actionStream: Stream<A>, stateStream: Stream<S>) => Stream<A>

  declare export type EpicMiddleware<A, S> = {
  ...
  declare export type ActionType = string | Symbol
  ...
  declare export var EPIC_END: '@@redux-most/EPIC_END' & string
}
