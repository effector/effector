...
declare module "shelljs" {
   ...
   */
  declare export function cd(dir?: string): ShellString;

  /**
   * Returns the current directory.
   * @return The current directory.
   */
  declare export function pwd(): ShellString;
   ...
   */
  declare export function ls(...paths: Array<string | string[]>): ShellArray;
   ...
   */
  declare export function find(...path: Array<string | string[]>): ShellArray;
   ...
   * @return Object with shell exit code, stderr and stdout.
   */
  declare export function rm(...files: Array<string | string[]>): ShellString;
   ...
   * @return Object with shell exit code, stderr and stdout.
   */
  declare export function mkdir(...dir: Array<string | string[]>): ShellString;

  /**
   * Creates directories.
   * @param options Available options: p (full paths, will create intermediate dirs if necessary)
   * @param The directories to create.
   * @return Object with shell exit code, stderr and stdout.
   */
   ...
   */
  declare export function test(option: TestOptions, path: string): boolean;
   ...
   */
  declare export function cat(...files: Array<string | string[]>): ShellString;
   ...
   */
  declare export function which(command: string): ShellString;
   ...
   */
  declare export function echo(...text: string[]): ShellString;
   ...
   * @return Returns the string that was passed as argument.
   */
  declare export function echo(options: string, ...text: string[]): ShellString;
   ...
   */
  declare export function pushd(dir: "+N"): ShellArray;
   ...
   * @return Returns an array of paths in the stack.
   */
  declare export function pushd(dir: string): ShellArray;
   ...
   * @return Returns an array of paths in the stack.
   */
  declare export function pushd(options: string, dir: "+N"): ShellArray;
   ...
   * @return Returns an array of paths in the stack.
   */
  declare export function pushd(options: string, dir: string): ShellArray;
   ...
   * @return Returns an array of paths in the stack.
   */
  declare export function popd(dir: "+N"): ShellArray;

  /**
   * When no arguments are given, popd removes the top directory from the stack and performs a cd to the new top directory. The elements are numbered from 0 starting at the first directory listed with dirs; i.e., popd is equivalent to popd +0. Returns an array of paths in the stack.
   * @return Returns an array of paths in the stack.
   */
  declare export function popd(): ShellArray;
   ...
   * @return Returns an array of paths in the stack.
   */
  declare export function popd(dir: string): ShellArray;
   ...
   * @return Returns an array of paths in the stack.
   */
  declare export function popd(options: string, dir: "+N"): ShellArray;
   ...
   * @return Returns an array of paths in the stack.
   */
  declare export function popd(options: string, dir: string): ShellArray;
   ...
   */
  declare export function dirs(options: "-c"): ShellArray;
   ...
   * @return Returns an array of paths in the stack, or a single path if +N or -N was specified.
   */
  declare export function dirs(options: "+N"): ShellString;
   ...
   * @return Object with shell exit code, stderr and stdout.
   */
  declare export function ln(source: string, dest: string): ShellString;
  ...
  declare export type ExecCallback = (
    code: number,
    stdout: string,
    stderr: string
  ) => any;
  declare export type ExecOptions = {
    /**
  ...
  declare export type ShellReturnValue = {
    /**
  ...
  declare export type ShellString = string & ShellReturnValue;
  declare export type ShellArray = string[] & ShellReturnValue;
   ...
   * @return Object with shell exit code, stderr and stdout.
   */
  declare export function chmod(octalMode: number, file: string): ShellString;
   ...
   * @return Object with shell exit code, stderr and stdout.
   */
  declare export function chmod(mode: string, file: string): ShellString;
   ...
   */
  declare export function tempdir(): ShellString;
   ...
   */
  declare export function error(): ShellString;

  declare export type TouchOptionsLiteral = "-a" | "-c" | "-m" | "-d" | "-r";
   ...
   */
  declare export interface TouchOptionsArray {
    "-d"?: string;
    "-r"?: string;
  }
  declare export function touch(...files: string[]): ShellString;
  ...
  declare export interface HeadOptions {
    /**
   ...
   */
  declare export function head(...files: Array<string | string[]>): ShellString;
   ...
   */
  declare export function sort(...files: Array<string | string[]>): ShellString;
  ...
  declare export interface TailOptions {
    /**
   ...
   */
  declare export function tail(...files: Array<string | string[]>): ShellString;

  /**
   * Read the end of a file.
   */
  declare export function tail(
    options: TailOptions,
    ...files: Array<string | string[]>
  ): ShellString;
   ...
   */
  declare export function uniq(input: string, output?: string): ShellString;
   ...
   */
  declare export function set(options: string): void;

  declare export interface ShellConfig {
    /**
