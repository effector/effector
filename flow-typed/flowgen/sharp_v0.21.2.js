...
declare module "sharp" {
  ...
  declare var npm$namespace$sharp: {
    ...
    concurrency: typeof sharp$concurrency,
    counters: typeof sharp$counters,
    simd: typeof sharp$simd,
    format: typeof sharp$format,
    versions: typeof sharp$versions,
    queue: typeof sharp$queue,
    gravity: typeof sharp$gravity,
    strategy: typeof sharp$strategy,
    kernel: typeof sharp$kernel,
    fit: typeof sharp$fit,
    bool: typeof sharp$bool
  };

  /**
   * Object containing nested boolean values representing the available input and output formats/methods.
   */
  declare var sharp$format: sharp$FormatEnum;

  /**
   * An Object containing the version numbers of libvips and its dependencies.
   */
  declare var sharp$versions: {
    vips: string,
    cairo?: string,
    croco?: string,
    exif?: string,
   ...
   */
  declare var sharp$queue: NodeJS.EventEmitter;
   ...
   */
  declare function sharp$cache(
    options?: boolean | sharp$CacheOptions
  ): sharp$CacheResult;
   ...
   */
  declare function sharp$counters(): sharp$SharpCounters;
   ...
   */
  declare function sharp$simd(enable?: boolean): boolean;

  declare var sharp$gravity: sharp$GravityEnum;

  declare var sharp$strategy: sharp$StrategyEnum;

  declare var sharp$kernel: sharp$KernelEnum;

  declare var sharp$fit: sharp$FitEnum;

  declare var sharp$bool: sharp$BoolEnum;

  declare type sharp$Sharp = {
    /**
     ...
     * @returns A sharp instance that can be used to chain operations
     */
    extractChannel(channel: number | string): sharp$Sharp,
     ...
     * @returns A sharp instance that can be used to chain operations
     */
    bandbool(boolOp: string): sharp$Sharp,
     ...
     * @returns A sharp instance that can be used to chain operations
     */
    tint(rgb: sharp$Color): sharp$Sharp,
     ...
     * @returns A sharp instance that can be used to chain operations
     */
    limitInputPixels(limit: number | boolean): sharp$Sharp,
     ...
     * @returns A sharp instance that can be used to chain operations
     */
    sequentialRead(sequentialRead?: boolean): sharp$Sharp,
     ...
     * @returns A sharp instance that can be used to chain operations
     */
    sharpen(sigma?: number, flat?: number, jagged?: number): sharp$Sharp,
     ...
     * @returns A sharp instance that can be used to chain operations
     */
    gamma(gamma?: number): sharp$Sharp,
     ...
     * @returns A sharp instance that can be used to chain operations
     */
    negate(negate?: boolean): sharp$Sharp,
     ...
     * @returns A sharp instance that can be used to chain operations
     */
    normalise(normalise?: boolean): sharp$Sharp,
     ...
     * @returns A sharp instance that can be used to chain operations
     */
    normalize(normalize?: boolean): sharp$Sharp,
     ...
     * @returns A sharp instance that can be used to chain operations
     */
    linear(a?: number, b?: number): sharp$Sharp,
    ...
    toFile(
      fileOut: string,
      callback: (err: Error, info: sharp$OutputInfo) => void
    ): sharp$Sharp,
     ...
     * @param Resolve the Promise with an Object containing data and info properties instead of resolving only with data.
     ...
     * @returns A sharp instance that can be used to chain operations
     */
    trim(threshold?: number): sharp$Sharp
  } & Duplex;

  declare interface sharp$SharpOptions {
    /**
  ...
  declare interface sharp$CacheOptions {
    /**
  ...
  declare interface sharp$SharpCounters {
    /**
  ...
  declare interface sharp$Raw {
    width: number;
    height: number;
    channels: 1 | 2 | 3 | 4;
  }

  declare interface sharp$Create {
    /**
  ...
  declare interface sharp$WriteableMetadata {
    /**
  ...
  declare interface sharp$ChannelStats {
    /**
  ...
  declare interface sharp$OutputOptions {
    /**
  ...
  declare type sharp$JpegOptions = {
    /**
  ...
  declare interface sharp$RotateOptions {
    /**
  ...
  declare interface sharp$FlattenOptions {
    /**
  ...
  declare interface sharp$ResizeOptions {
    /**
  ...
  declare interface sharp$Region {
    /**
  ...
  declare interface sharp$ExtendOptions {
    top?: number;
    left?: number;
    bottom?: number;
    right?: number;
   ...
   */
  declare type sharp$Channels = 3 | 4;

  declare interface sharp$RGBA {
    r?: number;
    g?: number;
    b?: number;
    alpha?: number;
  ...
  declare type sharp$Color = string | sharp$RGBA;

  declare interface sharp$Kernel {
    /**
  ...
  declare interface sharp$ThresholdOptions {
    /**
  ...
  declare interface sharp$OverlayOptions {
    /**
  ...
  declare interface sharp$TileOptions {
    /**
  ...
  declare interface sharp$AvailableFormatInfo {
    id: string;
    input: {
      file: boolean,
      buffer: boolean,
  ...
  declare interface sharp$FitEnum {
    contain: "contain";
    cover: "cover";
    fill: "fill";
    inside: "inside";
  ...
  declare interface sharp$KernelEnum {
    nearest: "nearest";
    cubic: "cubic";
    lanczos2: "lanczos2";
    lanczos3: "lanczos3";
  ...
  declare interface sharp$BoolEnum {
    and: "and";
    or: "or";
    eor: "eor";
  }

  declare interface sharp$ColourspaceEnum {
    multiband: string;
    "b-w": string;
    bw: string;
    cmyk: string;
  ...
  declare type sharp$Gravity = number | string;

  declare interface sharp$GravityEnum {
    north: number;
    northeast: number;
    southeast: number;
    south: number;
  ...
  declare interface sharp$StrategyEnum {
    entropy: number;
    attention: number;
  }

  declare interface sharp$FormatEnum {
    jpeg: sharp$AvailableFormatInfo;
    png: sharp$AvailableFormatInfo;
    webp: sharp$AvailableFormatInfo;
    raw: sharp$AvailableFormatInfo;
    tiff: sharp$AvailableFormatInfo;
    dz: sharp$AvailableFormatInfo;
    input: sharp$AvailableFormatInfo;
    magick: sharp$AvailableFormatInfo;
    openslide: sharp$AvailableFormatInfo;
    ppm: sharp$AvailableFormatInfo;
    fits: sharp$AvailableFormatInfo;
    gif: sharp$AvailableFormatInfo;
    svg: sharp$AvailableFormatInfo;
    pdf: sharp$AvailableFormatInfo;
    v: sharp$AvailableFormatInfo;
  }

  declare interface sharp$CacheResult {
    memory: {
      current: number,
      high: number,
      max: number
