...
declare module "fastify" {
  ...
  import typeof * as http2 from "http2";
  ...
  declare function fastify<
    ...
    HttpRequest: http.IncomingMessage | http2.Http2ServerRequest,
    HttpResponse: http.ServerResponse | http2.Http2ServerResponse
  >(
    opts?: fastify$fastify$ServerOptions
  ): fastify$fastify$FastifyInstance<HttpServer, HttpRequest, HttpResponse>;

  declare function fastify(
    opts?: fastify$fastify$ServerOptionsAsHttp
  ...
  declare function fastify(
    opts?: fastify$fastify$ServerOptionsAsSecureHttp
  ): fastify$fastify$FastifyInstance<
    https.Server,
    http.IncomingMessage,
    http.ServerResponse
  ...
  declare function fastify(
    opts?: fastify$fastify$ServerOptionsAsHttp2
  ): fastify$fastify$FastifyInstance<
    http2.Http2Server,
  ...
  declare function fastify(
    opts?: fastify$fastify$ServerOptionsAsSecureHttp2
  ): fastify$fastify$FastifyInstance<
  ...
  declare type fastify$BodyParser<HttpRequest, RawBody: string | Buffer> =
    | ((
        req: HttpRequest,
        rawBody: RawBody,
   ...
   * Register options
   */
  declare type fastify$RegisterOptions<
    HttpServer,
    HttpRequest,
    HttpResponse
  > = {
    [key: string]: any,
    prefix?: string
  } & fastify$RouteShorthandOptions<HttpServer, HttpRequest, HttpResponse>;
  ...
  declare interface fastify$HTTPInjectOptions {
    ...
    payload?: string | { [key: string]: any } | Buffer | NodeJS.ReadableStream;
    simulate?: {
      end?: boolean,
      split?: boolean,
      error?: boolean,
  ...
  > {
     ...
     * Registers a plugin
     */
    register<T: fastify$RegisterOptions<HttpServer, HttpRequest, HttpResponse>>(
     ...
     */
    addSchema(schema: { [key: string]: any }): fastify$FastifyInstance<
      HttpServer,
      HttpRequest,
      HttpResponse
    >;
